          ...
          <DialogContent>
            ...
            <DialogContentText>
              <Typography variant="body2" style={{ paddingTop: "20px" }}>
                Private rooms are only accessible to people you invite. Public
                rooms are displayed on our page and anyone can join!
              </Typography>
            </DialogContentText>
            ...
            <FormControl component="fieldset">
              <FormLabel
                component="legend"
                style={{ color: "#cfd8dc", paddingTop: "20px" }}
              >
                Room Type
              </FormLabel>
              <RadioGroup
              ...
              >
                <FormControlLabel
                  value="true"
                  control={<Radio style={{ color: "rgb(23, 243, 255)" }} />}
                  label="public"
                />
                <FormControlLabel
                  value="false"
